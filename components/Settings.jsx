        ...
        <Box px={settingsPad} color="gray.700" className='settings i'  >
            ...
            <Box mt='12'>
                ...
                <Flex justify="space-between" align="center" name='settings' wrap='wrap'>
                    ...
                    <Flex align="baseline" mr='0.5rem'>
                        <FormLabel fontSize={font_size_small} htmlFor="show_twitter_icon" display="flex" alignItems="center" >Twitter Icon</FormLabel>
                        <Switch size="md" id="show_twitter_icon" isChecked={props.showTwitterIcon} onChange={() => props.setShowTwitterIcon(!props.showTwitterIcon)} />
                    </Flex>
                </Flex>
            </Box>
