    ...
    if(hint){
    	return (
    		<Box m="0 auto" className='non-tweet i' py='2rem' flexDirection='column'>
    		    ...
    		    <Text fontSize='2rem' className='i' p='4' color='gray.700' textAlign='center'>Welcome, paste the link of the tweet in the box above</Text>
                <Text>If you want to try it out, here are some of my favourite tweets.</Text>
                <Box py='3' color='gray.500'>
                    <Text>https://twitter.com/naval/status/1158966154892697602</Text>
                    <Text>https://twitter.com/karpathy/status/1325154823856033793</Text>
                </Box>
    		</Box>
    	)
    }
