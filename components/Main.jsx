...
const Main = ({scale, hint, loading, error, tweetData, bg, showTime, showMetrics, showSource}) => {
    ...
    if(hint){
    	return (
    		<Box m="0 auto" className='non-tweet' py='2rem' flexDirection='column'>
    		    <Box>
    ...
    if(loading){
    	return <Box minW={pic_size} m="0 auto" className='non-tweet'><Spinner size='xl' /> </Box>
    }
